...
def get_args():
    ...
    parser.add_argument('--mention_detection_mode', type=str, required=True, help='options are LSTM, GRU')
    ...
    # added for demo
    parser.add_argument('--input', type=str, default='Which teams have James played basketball?')
